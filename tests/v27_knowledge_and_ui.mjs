...
const compound=searchCustomerKnowledgeV27("مكانكم فين وهل خيار وفرة متوفر وبكام؟",{limit:4});assert.ok(compound.items.length);assert.ok(compound.packs_scanned.length<=1);
const agriculture=searchCustomerKnowledgeV27("اصفرار الطماطم والجذور والري",{limit:4});assert.ok(agriculture.items.length);
