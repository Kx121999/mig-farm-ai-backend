...
assert.equal(identity.version,"31.0.0");assert.equal(identity.mode,"llm_first_semantic_orchestrator_v31");assert.equal(identity.source,"v27_customer_brain_compound");
