...
assert.equal(identity.version,"27.0.0");assert.equal(identity.mode,"customer_brain_decision_os_v27");assert.equal(identity.source,"v27_customer_brain_compound");
