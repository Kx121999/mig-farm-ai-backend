...
assert.ok(["18.0.0","19.0.0","20.0.0"].includes(r.version)); assert.ok(["current_turn_semantic_human_sales_employee_v18","conversion_decision_human_sales_employee_v19","product_intelligence_human_sales_employee_v20"].includes(r.mode));
