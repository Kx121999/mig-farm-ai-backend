...
const health=humanConversationHealth(); assert.ok(["18.0","22.1","22.2","22.4"].includes(health.version)); assert.ok(health.capabilities.includes("stale_context_quarantine")); assert.ok(health.capabilities.includes("vision_first_override"));
