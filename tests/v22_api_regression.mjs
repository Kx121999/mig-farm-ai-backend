...
assert.equal(h.version,"22.0.0");
assert.equal(h.mode,"multimodal_agricultural_product_vision_sales_os_v22");
assert.equal(h.vision_intelligence?.version,"22.0");
...
assert.equal(h.neural_brain?.version,"22.0");
...
assert.equal(r.version,"22.0.0");
assert.equal(r.mode,"multimodal_agricultural_product_vision_sales_os_v22");
assert.equal(r.runtime?.vision_intelligence?.version,"22.0");
