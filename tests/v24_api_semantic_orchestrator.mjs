...
assert.equal(health.semantic_human_brain?.version,"25.0");
...
assert.equal(result.version,"25.0.0");
assert.equal(result.mode,"autonomous_sales_learning_agent_os_v25");
