...
assert.equal(health.semantic_human_brain?.version,"26.0");
...
assert.equal(result.version,"26.0.0");
assert.equal(result.mode,"github_knowledge_natural_conversation_os_v26");
