...
assert.ok(["21.0.0","22.0.0","22.1.0","22.2.0","22.3.0"].includes(h.version));
...
assert.ok(["21.0","22.1","22.2","22.3"].includes(h.product_truth_os?.version));
...
assert.ok(["21.0","22.1","22.2","22.3"].includes(h.conversion_decision_brain?.version));
assert.ok(["21.0","22.0","22.1","22.2","22.3"].includes(h.neural_brain?.version));
...
assert.ok(["21.0.0","22.0.0","22.1.0","22.2.0","22.3.0"].includes(r.version));
...
assert.ok(["21.0","22.1","22.2","22.3"].includes(r.runtime?.product_truth_os?.version));
