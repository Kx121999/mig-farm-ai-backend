...
assert.ok(["21.0.0","22.0.0","22.1.0"].includes(h.version));
assert.ok(["live_product_truth_sales_action_os_v21","multimodal_agricultural_product_vision_sales_os_v22","multimodal_agricultural_product_vision_stability_os_v22_1"].includes(h.mode));
assert.ok(["21.0","22.1"].includes(h.product_truth_os?.version));
...
assert.ok(["21.0","22.1"].includes(h.conversion_decision_brain?.version));
assert.ok(["21.0","22.0","22.1"].includes(h.neural_brain?.version));
...
assert.ok(["21.0.0","22.0.0","22.1.0"].includes(r.version));
assert.ok(["live_product_truth_sales_action_os_v21","multimodal_agricultural_product_vision_sales_os_v22","multimodal_agricultural_product_vision_stability_os_v22_1"].includes(r.mode));
assert.ok(["21.0","22.1"].includes(r.runtime?.product_truth_os?.version));
