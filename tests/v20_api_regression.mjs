...
assert.equal(h.version,"20.0.0");
assert.equal(h.mode,"product_intelligence_human_sales_employee_v20");
...
assert.equal(h.neural_brain?.version,"20.0");
...
assert.equal(r.version,"20.0.0");
assert.equal(r.mode,"product_intelligence_human_sales_employee_v20");
