...
assert.ok(["20.0.0","21.0.0","22.0.0"].includes(h.version));
assert.ok(["product_intelligence_human_sales_employee_v20","live_product_truth_sales_action_os_v21","multimodal_agricultural_product_vision_sales_os_v22"].includes(h.mode));
...
assert.ok(["20.0","21.0","22.0"].includes(h.neural_brain?.version));
...
assert.ok(["20.0.0","21.0.0","22.0.0"].includes(r.version));
assert.ok(["product_intelligence_human_sales_employee_v20","live_product_truth_sales_action_os_v21","multimodal_agricultural_product_vision_sales_os_v22"].includes(r.mode));
