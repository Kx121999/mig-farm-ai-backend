...
assert.ok(["20.0.0","21.0.0","22.0.0","22.1.0","22.2.0","22.5.0","23.0.0","24.0.0"].includes(h.version));
assert.ok(["product_intelligence_human_sales_employee_v20","live_product_truth_sales_action_os_v21","multimodal_agricultural_product_vision_sales_os_v22","multimodal_agricultural_product_vision_stability_os_v22_1","multimodal_visual_intent_product_precision_os_v22_2","multimodal_product_context_lock_os_v22_5","server_authoritative_product_context_intelligence_os_v23","semantic_human_conversation_orchestrator_os_v24"].includes(h.mode));
...
assert.ok(["20.0","21.0","22.0","22.1","22.2","22.5","24.0"].includes(h.neural_brain?.version));
...
assert.ok(["20.0.0","21.0.0","22.0.0","22.1.0","22.2.0","22.5.0","23.0.0","24.0.0"].includes(r.version));
assert.ok(["product_intelligence_human_sales_employee_v20","live_product_truth_sales_action_os_v21","multimodal_agricultural_product_vision_sales_os_v22","multimodal_agricultural_product_vision_stability_os_v22_1","multimodal_visual_intent_product_precision_os_v22_2","multimodal_product_context_lock_os_v22_5","server_authoritative_product_context_intelligence_os_v23","semantic_human_conversation_orchestrator_os_v24"].includes(r.mode));
