...
assert.ok(["19.0.0","20.0.0","21.0.0","22.0.0","22.1.0","22.2.0"].includes(h.version));
assert.ok(["conversion_decision_human_sales_employee_v19","product_intelligence_human_sales_employee_v20","live_product_truth_sales_action_os_v21","multimodal_agricultural_product_vision_sales_os_v22","multimodal_agricultural_product_vision_stability_os_v22_1","multimodal_visual_intent_product_precision_os_v22_2"].includes(h.mode));
assert.ok(["19.0","20.0","21.0","22.1","22.2"].includes(h.conversion_decision_brain?.version));
assert.ok(["19.0","20.0","21.0","22.2"].includes(h.sales_employee?.version));
assert.ok(["19.0","20.0","21.0","22.0","22.1","22.2"].includes(h.neural_brain?.version));
...
assert.ok(["19.0.0","20.0.0","21.0.0","22.0.0","22.1.0","22.2.0"].includes(r.version));assert.ok(["conversion_decision_human_sales_employee_v19","product_intelligence_human_sales_employee_v20","live_product_truth_sales_action_os_v21","multimodal_agricultural_product_vision_sales_os_v22","multimodal_agricultural_product_vision_stability_os_v22_1","multimodal_visual_intent_product_precision_os_v22_2"].includes(r.mode));
