...
assert.equal(visionHealth().version,"22.4");
...
const persisted=sanitizeState({v:22.4,turn:3,active_visual_context:active});
assert.equal(persisted.v,22.4);
...
assert.equal(r1.version,"22.4.0");
assert.equal(r1.source,"v22_4_visual_recognition_safe_fallback");
...
assert.equal(r2.source,"v22_4_visual_recognition_safe_fallback");
