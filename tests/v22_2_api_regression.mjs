...
assert.equal(h.human_conversation_brain?.version,"22.2");
assert.equal(h.conversion_decision_brain?.version,"22.2");
...
assert.equal(r.source,"v22_2_visual_intent_safe_fallback");
...
assert.ok(r.visual_guidance.actions.some(x=>x.type==="camera"));
