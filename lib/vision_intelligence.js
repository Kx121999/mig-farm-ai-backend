...
export function buildRetakeAdvice(frame={},observation={}){
  ...
  if(mode==="plant_diagnostic"||intent==="diagnosis"){
    ...
    ask_one="حللت الصورة وحاولت أطابق المنتج أولًا. لو الاسم مش واضح، صوّر اسم المنتج أو الـSKU/الباركود أقرب وبشكل مستقيم ومن غير انعكاس.";
    ...
    ask_one="ابعت صورة أقرب وواضحة للجزء المهم في سؤالك.";target="decisive_visual_detail";actions=[{type:"camera",label:"صوّر الجزء أقرب",target:"decisive_visual_detail"}];
  }
