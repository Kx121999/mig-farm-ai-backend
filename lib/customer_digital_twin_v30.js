...
function candidates({frame={},analysis={},semanticFrame={},profile={},reasoning={},turn=0}={}){
  ...
  const items=[
    ...
    ["product_reference",entities.product_reference||resolved.product?.sku||resolved.product?.name||analysis?.v29_reference_product?.sku||analysis?.v29_reference_product?.name,.92,"explicit_product_reference"]
  ];
