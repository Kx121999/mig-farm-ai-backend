...
const ALL_TOOLS=[
  ...
  "search_agricultural_engineering","diagnose_crop_problem","agriculture_calculator",
  ...
  "search_knowledge","search_site","recall_memory"
];
...
function toolsFor({intents=[],risk={},hasImages=false,analysis={}}={}){
  ...
  if(risk.diagnosis)tools.push("diagnose_crop_problem","search_agricultural_engineering","search_agricultural_master");
  if(risk.dosage||risk.regulated)tools.push("get_product_dossier","verify_live_product_truth","search_knowledge");
  if(hasImages)tools.push("match_visual_product","verify_visual_product_live","search_visual_agronomy");
  if(!tools.length&&intents.length)tools.push("search_knowledge","search_site");
