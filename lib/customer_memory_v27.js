...
export function sanitizeCustomerMemoryV27(value={}){
  return {
    ...
    last_goal:clean(value.last_goal,80),last_product_reference:clean(value.last_product_reference,260),recent_goals:list(value.recent_goals,8),objections:list(value.objections,6),
...
export function mergeCustomerMemoryV27(previous={},frame={},turn=0){
  ...
  return sanitizeCustomerMemoryV27({
    ...
    last_product_reference:entities.product_reference||old.last_product_reference,recent_goals:[...old.recent_goals,...goals],objections,updated_turn:turn
  });
}
