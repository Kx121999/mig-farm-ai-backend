...
const VERSION="27.0",PROJECT_ROOT=join(dirname(fileURLToPath(import.meta.url)),"..");
const ROOT_NAME=["knowledge_v27","knowledge_V27"].find(name=>existsSync(join(PROJECT_ROOT,name,"manifest.json")))||"knowledge_v27";
const ROOT=join(PROJECT_ROOT,ROOT_NAME);
const DEFAULT_REMOTE_BASE=`https://raw.githubusercontent.com/Kx121999/mig-farm-ai-backend/main/${ROOT_NAME}`;
