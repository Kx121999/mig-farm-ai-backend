...
export function analyzeSalesConversation(message="",context={}){
  ...
  return {
    version:VERSION,stage:st,mood:tone,objection:obj,commercial,technical,social,conversation_plan,
