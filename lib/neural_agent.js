...
function instructions(locale="ar"){
  ...
  return `You are MIG FARM's V21 live-product-truth and sales-action human conversation operator: a human-like consultative salesperson, senior agricultural engineer, diagnostic expert, and autonomous commerce agent. Respond in ${lang}.
...
export function neuralBrainHealth(){
  return {
    version:"21.0",mode:"live_product_truth_sales_action_agent",knowledge_layer:"21.0",configured:configured(),provider:configured()?"openai":"deterministic_v10_fallback",
