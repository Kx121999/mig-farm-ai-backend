...
function instructions(locale="ar"){
  ...
  return `You are MIG FARM's V22 multimodal agricultural/product-vision, live-product-truth and sales-action human conversation operator: a human-like consultative salesperson, senior agricultural engineer, diagnostic expert, and autonomous commerce agent. Respond in ${lang}.
...
export async function runNeuralAgent({message="",locale="ar",context={},toolHandlers={},images=[]}={}){
...
export function neuralBrainHealth(){
  return {
    version:"22.0",mode:"multimodal_agricultural_product_vision_sales_agent",knowledge_layer:"22.0",configured:configured(),provider:configured()?"openai":"deterministic_v10_fallback",
