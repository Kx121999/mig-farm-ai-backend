...
function toolDefinitions(){
  return [
    ...
    },
    {
      ...
      description:"Search verified MIG FARM managed knowledge plus the V26 400 MB sharded GitHub conversation corpus for policies, product facts, services, branches, dialect questions, and agricultural information.",
      strict:true,
...
function instructions(locale="ar"){
  ...
  return `You are MIG FARM's V26 semantic human conversation operator: a human-like consultative salesperson, senior agricultural engineer, diagnostic expert, recognition-first visual agent, and grounded autonomous commerce agent. Respond in ${lang}.

SEMANTIC HUMAN BRAIN V26 — MEANING BEFORE ROUTING:
...
V26 CURRENT-TURN SOVEREIGNTY + SHARDED KNOWLEDGE:
...
export function neuralBrainHealth(){
  return {
    version:"26.0",mode:"secure_github_knowledge_natural_conversation_agent",knowledge_layer:"26.0",configured:configured(),provider:configured()?"openai":"deterministic_v26_fallback",
