...
export function shouldUseNeuralAgent({message="",analysis={},cognition={},plan={},salesTurn=null,image_count=0}={}){
  ...
  if(["16.0","17.0","18.0","19.0","20.0","21.0"].includes(salesTurn?.version||"")) return true;
...
function instructions(locale="ar"){
  ...
  return `You are MIG FARM's V22.1 multimodal agricultural/product-vision, live-product-truth and sales-action human conversation operator: a human-like consultative salesperson, senior agricultural engineer, diagnostic expert, and autonomous commerce agent. Respond in ${lang}.
...
export async function runNeuralAgent({message="",locale="ar",context={},toolHandlers={},images=[],allowedTools=null}={}){
  ...
  const visionToolNames=new Set(["match_visual_product","verify_visual_product_live","guard_visual_label_claim","search_visual_agronomy","get_retake_advice"]);
