...
export function salesConversationOSHealth(){
  return {version:VERSION,mode:"human_sales_conversation_os_conversion_aware",capabilities:["turn_level_goal_selection","buyer_readiness_inference","objection_root_cause_detection","next_best_action","adaptive_reply_shapes","history_aware_followups","response_repetition_guard","question_budgeting","soft_close_logic","no_product_push_when_not_needed","trust_friction_resolution","anti_fake_urgency","anti_fake_discount","naturalness_quality_gate","current_turn_semantic_priority","stale_context_guard","conversion_decision_handoff"]};
}
