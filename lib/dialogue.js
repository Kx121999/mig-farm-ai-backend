...
export function updateState(previous,analysis,message,source="",results=[],responsePayload={}){
  ...
  }else if(["greeting","wellbeing","thanks","goodbye","identity","branches","shipping","delivery_time","contact","hours","payment","returns","order_status","complaint"].includes(analysis.intent)){
