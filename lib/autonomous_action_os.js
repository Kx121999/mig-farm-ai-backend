...
export async function handleAutonomousAction({message="",semanticFrame={},state={},selectedProduct=null,selectedProducts=[],actionRequest=null,locale="ar",gateway=null,resolvePendingOnly=false}={}){
  ...
  if(resolvePendingOnly)return {handled:false,state:pending};
