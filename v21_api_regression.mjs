...
assert.ok(["21.0.0","22.0.0","22.1.0","22.2.0","22.5.0"].includes(h.version));
assert.ok(["live_product_truth_sales_action_os_v21","multimodal_agricultural_product_vision_sales_os_v22","multimodal_agricultural_product_vision_stability_os_v22_1","multimodal_visual_intent_product_precision_os_v22_2","multimodal_product_context_lock_os_v22_5"].includes(h.mode));
...
assert.ok(["21.0.0","22.0.0","22.1.0","22.2.0","22.5.0"].includes(r.version));
assert.ok(["live_product_truth_sales_action_os_v21","multimodal_agricultural_product_vision_sales_os_v22","multimodal_agricultural_product_vision_stability_os_v22_1","multimodal_visual_intent_product_precision_os_v22_2","multimodal_product_context_lock_os_v22_5"].includes(r.mode));
