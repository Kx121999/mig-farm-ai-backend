...
const cases=JSON.parse(readFileSync(new URL("../evals/v33_locked_holdout_d.json",import.meta.url),"utf8"));
const productState={turn:15,topic:"product",intelligence_v33:{version:"33.0",turn:15,active_topic:"products",active_products:[{entity_id:"locked-a",name:"مياسة F1",sku:"A"}],visible_products:[{entity_id:"locked-a",name:"مياسة F1",sku:"A"},{entity_id:"locked-b",name:"مزيونة F1",sku:"B"}],active_product_id:"locked-a",active_crop:"باذنجان",last_route:"product_discovery"}};
