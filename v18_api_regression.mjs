...
assert.ok(["18.0.0","19.0.0","20.0.0","21.0.0","22.0.0","22.1.0","22.2.0","22.5.0"].includes(r.version)); assert.ok(["current_turn_semantic_human_sales_employee_v18","conversion_decision_human_sales_employee_v19","product_intelligence_human_sales_employee_v20","live_product_truth_sales_action_os_v21","multimodal_agricultural_product_vision_sales_os_v22","multimodal_agricultural_product_vision_stability_os_v22_1","multimodal_visual_intent_product_precision_os_v22_2","multimodal_product_context_lock_os_v22_5"].includes(r.mode));
