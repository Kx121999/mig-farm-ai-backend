...
assert.equal(h.version,'22.5.0');
assert.equal(h.mode,'multimodal_product_context_lock_os_v22_5');
...
try{
  ...
  assert.equal(unbound.source,'v22_5_unbound_product_detail_guard');
  ...
  assert.equal(bound.source,'v22_5_bound_product_dossier');
